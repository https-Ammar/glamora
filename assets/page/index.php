...
<body>
        ...
        if ($fetchcat) {
          ...
          <div class="slider">
            ...
            while ($fetchad = $selectad->fetch_assoc()) {
              ...
              // تأكد من تنسيق الصورة بشكل صحيح
              ...
              echo '
                <a class="slider ' . $firstAdClass . '" href="' . $link . '">
                ...
                <div class="slider-container">
                  <div class="owl-carousel js-home-products">
                    ...
                    while ($fetchproducts = $selectproduct->fetch_assoc()) {
                      ...
                      $productImage = htmlspecialchars($imagePath . ltrim($fetchproducts['img'], './'), ENT_QUOTES, 'UTF-8');
                      $productPrice = htmlspecialchars($fetchproducts['total_final_price'], ENT_QUOTES, 'UTF-8');
                      $productDiscount = (int) $fetchproducts['discount'];
                      ...
                      <div class="item">
                        ...
                        <div class="flex_pric playSound" onclick="addcart(<?php echo $productId; ?>)">
                          ...
                          <div class="block_P">
                            <span class="price text"><?php echo $productPrice; ?></span><span>EGP</span>
                          </div>
                        </div>
  ...
  <script src="assets/app/carousel.js"></script>
