...
<i class="uil uil-search search-icon" id="searchIcon2"></i>
          ...
          <i class="uil uil-search search-icon" id="searchIcon1"></i>      
                <input id="search-input" name="search"  type="text" placeholder="Search here..." 
         ...
         <section class="logo_">
        <ul>
          <li >     <a href="./index.php" class="a_link">
   ...
   <p class="logo_">GLAMORA</p>
    ...
    <section class="_main_logo">
      ...
      <div class="Categories">
        <ul>
          <?php
          $sqlcat = mysqli_query($conn, "SELECT * FROM catageories"); // استعلام التصنيفات
          $count = 0; // عداد التصنيفات

          while ($fetchcat = mysqli_fetch_assoc($sqlcat)) {
            if ($count >= 8) {
              break; // إنهاء التكرار إذا وصلنا إلى 8 تصنيفات
            }
            echo '<li>
...
left: 0;
  ...
  <!-- Content to be dynamically loaded by AJAX will appear here -->
</header>
