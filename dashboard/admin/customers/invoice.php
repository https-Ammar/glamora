...
$items = $conn->query("
    SELECT p.name, p.image, oi.price, oi.qty
    FROM order_items oi
                                    ...
                                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                        <?php $i = 1; foreach ($items as $item): ?>
                                            <tr>
                                                ...
                                                <td class="px-5 py-3 text-sm font-medium whitespace-nowrap text-gray-800 dark:text-white/90"><?php echo htmlspecialchars($item['name']); ?></td>
