...
<body>
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="border-b border-gray-200 p-4 sm:p-8 dark:border-gray-800" x-data="invoiceProducts()">
            ...
            <!-- Add Form -->
            <div
                class="mt-5 rounded-xl border border-gray-100 bg-gray-50 p-4 sm:p-6 dark:border-gray-800 dark:bg-gray-900">
                <form @submit.prevent="addProduct">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 lg:grid-cols-12">
                        <div class="w-full lg:col-span-3">
                            <label
                                class="mb-1 inline-block text-sm font-semibold text-gray-700 dark:text-gray-400">Product
                                Name</label>
                        ...
                        <div class="w-full lg:col-span-3">
                            <label
                                class="mb-1 inline-block text-sm font-semibold text-gray-700 dark:text-gray-400">Price</label>
                            <input type="number" x-model.number="form.price" min="0" placeholder="Enter product price"
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                required="">
                        </div>
                        <div class="w-full lg:col-span-2">
                            <label
                                class="mb-1 inline-block text-sm font-semibold text-gray-700 dark:text-gray-400">Quantity</label>
                            <div
                                ...
                                <button type="button" @click="form.quantity = Math.max(1, form.quantity - 1)"
                                    class="inline-flex w-1/3 items-center justify-center bg-white text-gray-700 hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white">
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6.66699 12H18.6677" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                </button>
                                <div class="w-1/3">
                                    <input type="number" min="1" x-model.number="form.quantity"
                                ...
                                <button type="button" @click="form.quantity++"
                                    ...
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6.66699 12.0002H18.6677M12.6672 6V18.0007" stroke="currentColor"
                ...
                <div class="mt-5 flex max-w-2xl items-center gap-2">
                    <svg class="text-gray-500 dark:text-gray-400" width="20" height="20" viewBox="0 0 20 20" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 7.22485H10.0007" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        After filling in the product details, press Enter/Return
                        or click 'Save Product' to add it to the list.
                    </p>
                </div>
            </div>
